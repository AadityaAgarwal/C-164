...
AFRAME.registerComponent('boxes', {
  schema: { width: { type: 'number', default: 2 }, height: { type: 'number', default: 2 }, depth: { type: 'number', default: 2 } },
  
  init: function () { this.spawnBox() },
  ...
  spawnBox: function () {
    ...
    for (i = 1; i <= 20; i++) {
      boxEntity = document.createElement('a-entity')
      ...
      boxEntity.setAttribute('position', { x: posX, y: posY, z: posZ })
      boxEntity.setAttribute('geometry', { primitive: 'box', height: this.data.height, width: this.data.width, depth: this.data.depth })

      boxEntity.setAttribute('material', { src: './images/boxtexture1.jpg', repeat: '1 1 1' })
